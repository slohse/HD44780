...
HD44780 lcd;
HD44780_STM32F4xx_GPIO_Driver lcd_pindriver;
...
void init_lcd(void)
{
  const HD44780_STM32F4xx_Pinout lcd_pinout =
  {
    {
      /* RS        */  { GPIOD, GPIO_PIN_15 },
      /* ENABLE    */  { GPIOD, GPIO_PIN_11 },
      /* RW        */  { GPIOD, GPIO_PIN_13 },
      /* Backlight */  { NULL, 0 },
      /* DP0       */  { NULL, 0 },
      /* DP1       */  { NULL, 0 },
      /* DP2       */  { NULL, 0 },
  ...
  lcd_pindriver.interface = HD44780_STM32F4XX_PINDRIVER_INTERFACE;
